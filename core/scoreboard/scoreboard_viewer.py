...
🎯 Top Flag = User's highest count flag (e.g., PII: 9) | ⏱️ Duration = Total session time
    ...
    def setup_scoreboard_table(self, parent):
        ...
        columns = ('Rank', 'User', 'Lines of Code', 'Sensitive Fields', 'Sensitive Data', 'Risk Score', 'Points', 'Top Flag', 'Duration')
    ...
    def update_scoreboard(self):
        ...
        for rank, entry in enumerate(all_users, 1):
            ...
            self.scoreboard_tree.insert('', 'end', values=(
                ...
                entry.detected_flags,  # Sensitive Fields (now column 3)
                entry.total_potential_flags,  # Sensitive Data (now column 4)
                entry.risk_score,
